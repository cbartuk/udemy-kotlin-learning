package com.canbartukilic.kotlinlearning
...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        */
        ...
        myStringArrayList.add("Bartu")
        myStringArrayList.add("Kilic")
